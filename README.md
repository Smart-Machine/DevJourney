...
- Internet
    - How does the internet work?
        ...
        - [How does the Internet Work?](http://web.stanford.edu/class/msande91si/www-spr04/readings/week1/InternetWhitepaper.html)
        - [How does the Internet work?](https://roadmap.sh/guides/what-is-internet)
        - [How does the INTERNET work?](https://youtu.be/x3c1ih2NJEg)
        - [How does the Internet work in 5 minutes](https://youtu.be/7_LPdttKXPc)
    ...
    - What is HTTP?
        ...
        - [HTTP/1 to HTTP/2 to HTTP/3](https://youtu.be/a-sBfyiXysI)
    ...
    - DNS and how it works?
        ...
        - [DNS 101 Miniseries](https://www.youtube.com/watch?v=zEmUuNFBgN8&list=PLTk5ZYSbd9MhMmOiPhfRJNW7bhxHo4q-K)
    ...
    - What is hosting?
        ...
        - [Where to Host a Fullstack Project on a Budget](https://youtu.be/Kx_1NYYJS7Q)
...
* OS and General Knowledge
    ...
    - How OS work in General
        ...
        - [Operating System - Overview](https://www.tutorialspoint.com/operating_system/os_overview.html)
        - [How OSs work in General](https://infinite.education/view/how_oss_work_in_general)
    ...
    - Basic Terminal Commands
        ...
        - [Command Line Tutorial (Course)](https://www.learnenough.com/command-line-tutorial)
    ...
    - I/O Management
        - [Operating System - I/O Hardware](https://www.tutorialspoint.com/operating_system/os_io_hardware.html)
        - [IO Management](https://www.omscs-notes.com/operating-systems/io-management/)
        - [Basics of OS (I/O Structure)](https://youtu.be/F18RiREDkwE)
    - POSIX Basics
...
* Learn a Language
    - C#
        - [Take your first steps with C#](https://learn.microsoft.com/en-us/training/paths/csharp-first-steps/?WT.mc_id=dotnet-35129-website)
...
* Version Control System
    - Basic Usage of Git
        ...
        - [Learn Git in 20 Minutes](https://youtu.be/Y9XZQO1n_7c)
    - Repo hosting services
        ...
        - [Git and GitHub - CS50 Beyond 2019](https://youtu.be/eulnSXkhE7I)
    ...
    - Mercurial
        - [Official Documentation](https://www.mercurial-scm.org/)
...
* Relational Databases
    ...
    - PostgreSQL
        ...
        - [PostgreSQL Tutorial For Beginners](https://www.youtube.com/watch?v=eMIxuk0nOkU)
    - MySQL
        - [Official Documentation](https://www.mysql.com/)
        - [MySQL Tutorial](https://www.w3schools.com/mySQl/default.asp)
        - [MySQL Tutorial for Beginners (Full Course)](https://youtu.be/7S_tz1z_5bA)
    - MariaDB
        - [Official Documentation](https://mariadb.org/)
        - [MariaDB vs MySQL – Difference Between Them](https://www.guru99.com/mariadb-vs-mysql.html)
        - [MariaDB Tutorial](https://www.w3schools.blog/mariadb-tutorial)
        - [MariaDB Tutorial For Beginners in One Hour](https://youtu.be/_AMj02sANpI)
    - MS SQL
        - [Official Documentation](https://www.microsoft.com/en-ca/sql-server/)
        - [Tutorials for SQL Server](https://learn.microsoft.com/en-us/sql/sql-server/tutorials-for-sql-server-2016?view=sql-server-ver15)
        - [SQL Server Tutorial For Beginners](https://youtu.be/-EPMOaV7h_Q)
    - Oracle
        - [Official Documentation](https://docs.oracle.com/en/database/index.html)
        - [Oracle SQL Tutorial](https://www.youtube.com/watch?v=ObbNGhcxXJA)
...
* More about Databases
    ...
    - CAP Theorem
        ...
        - [CAP Theorem and it's applications in NoSQL Databases](https://www.ibm.com/uk-en/cloud/learn/cap-theorem)
